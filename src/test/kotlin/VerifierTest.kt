...
import com.android.keyattestation.verifier.challengeverification.ChallengeChecker
import com.android.keyattestation.verifier.challengeverification.MatchingChallenge
  ...
  fun verify_unexpectedRootKey_returnsPathValidationFailure() {
    assertIs<VerificationResult.PathValidationFailure>(
      verifier.verify(
        ...
        MatchingChallenge(ByteString.copyFromUtf8("challenge")),
      )
    )
  }
}

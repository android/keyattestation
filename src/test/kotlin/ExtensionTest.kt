...
class ExtensionTest {
  ...
  @Test
  fun authorizationList_fromAsn1_repeatedTagWithDifferentValues_success() {
    val seq =
      V3Extensions.buildAuthorizationList(KeyMintTag.BLOCK_MODE to 1, KeyMintTag.BLOCK_MODE to 2)
    val authList = AuthorizationList.from(seq)

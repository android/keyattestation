...
class ExtensionConstraintConfigTest {
  ...
  @Test
  fun ValidationLevelIsSatisfiedBy_strictWithNull_allowsAnyValue() {
    val level = ValidationLevel.STRICT(null)
  ...
  @Test
  fun ValidationLevelIsSatisfiedBy_ignore() {
  ...
  @Test
  fun SecurityLevelValidationLevelIsSatisfiedBy_strictWithNull_allowsOnlyNonSoftwareLevels() {
    val level = SecurityLevelValidationLevel.STRICT(null)
  ...
  @Test
  fun SecurityLevelValidationLevelIsSatisfiedBy_match_allowsAnyMatchingLevels() {
    val level = SecurityLevelValidationLevel.MATCH
  ...
  @Test
  fun SecurityLevelValidationLevelIsSatisfiedBy_exists_allowsLevels() {
    val level = SecurityLevelValidationLevel.EXISTS

    assertThat(level.isSatisfiedBy(keyDescriptionWithStrongBoxSecurityLevels)).isTrue()
    assertThat(level.isSatisfiedBy(keyDescriptionWithTeeSecurityLevels)).isTrue()
    assertThat(level.isSatisfiedBy(keyDescriptionWithSoftwareSecurityLevels)).isTrue()
    assertThat(level.isSatisfiedBy(keyDescriptionWithMismatchedSecurityLevels)).isTrue()
  }
}

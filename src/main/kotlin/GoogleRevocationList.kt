...
fun getGoogleRevocationStatusFromWeb(
  url: URL,
  ...
  try {
    connection.apply {
      ...
      if (responseCode != HttpURLConnection.HTTP_OK) {
        throw IOException("Failed to fetch revocation list from $url: HTTP $responseCode")
      }

      return parseAttestationStatus(inputStream)
    }
  } finally {

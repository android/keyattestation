...
object Certs {
  ...
  val rkpIntermediate = certFactory.rkpIntermediate
...
object Chains {
  ...
  val extended by lazy {
    ...
    KeyAttestationCertPath(
      certFactory.generateLeafCert(
        ...
        subject = X500Name("CN=Extended leaf with extension"),
  ...
  val certAfterTarget by lazy {
    ...
    KeyAttestationCertPath(
      certFactory.generateLeafCert(
        ...
        signingKey = certFactory.leafKey.private,
        extension = null,
        subject = X500Name("CN=Random no extension leaf after the leaf"),
        issuer = leafCert.subject,
      ),
      leafCert,
      Certs.factoryAttestation,
  ...
  @JvmStatic
  val unparseableKeyDescriptionExtension by lazy {
    KeyAttestationCertPath(
      certFactory.generateLeafCert(
        extension =
  ...
  val malformedProvisioningInfo by lazy {
    KeyAttestationCertPath(
      certFactory.generateLeafCert(),
      certFactory.generateAttestationCert(
        issuer = Certs.rkpIntermediate.subject,

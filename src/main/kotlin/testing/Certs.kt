...
object Certs {
  ...
  val factoryStrongBoxIntermediate = certFactory.factoryStrongBoxIntermediate
...
object CertLists {
  ...
  val validStrongboxFactoryProvisioned by lazy {
    listOf(
      ...
      certFactory.generateAttestationCert(issuer = Certs.factoryStrongBoxIntermediate.subject),
      Certs.factoryStrongBoxIntermediate,
      Certs.root,
    )
  }

...
public final class AttestationUiManager {
  ...
  public enum AttestationParameter {
    ...
    APPLICATION_ID(R.string.label_application_id),
    ATTESTATION_ID_DEVICE(R.string.label_id_device),
  ...
  public void updateSummaryStatus(boolean isVerified, VerifiedBootState bootState) {
    handler.post(
        () -> {
          ...
          int errorColor = R.color.error;
          int successColor = R.color.success;
          int warningColor = R.color.warning;

          if (!isVerified || bootState == null) {
            summaryTitle.setText(R.string.summary_title_unverified);
            summaryTitle.setTextColor(ContextCompat.getColor(activity, errorColor));
            summaryTitle.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_warning, 0, 0);
            summaryTitle.setCompoundDrawableTintList(
                ColorStateList.valueOf(ContextCompat.getColor(activity, errorColor)));
          ...
          switch (bootState) {
            case VERIFIED -> {
              ...
              summaryTitle.setTextColor(ContextCompat.getColor(activity, successColor));
              summaryTitle.setCompoundDrawablesWithIntrinsicBounds(
                  0, R.drawable.ic_check_circle, 0, 0);
              summaryTitle.setCompoundDrawableTintList(
                  ColorStateList.valueOf(ContextCompat.getColor(activity, successColor)));
              summarySubtitle.setText(R.string.summary_subtitle_verified);
            }
            case SELF_SIGNED -> {
              summaryTitle.setText(R.string.summary_title_warning);
              summaryTitle.setTextColor(ContextCompat.getColor(activity, warningColor));
              summaryTitle.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_warning, 0, 0);
              summaryTitle.setCompoundDrawableTintList(
                  ColorStateList.valueOf(ContextCompat.getColor(activity, warningColor)));
              summarySubtitle.setText(R.string.summary_subtitle_warning);
            }
  ...
  public String getParameterDescription(
    ...
    switch (parameter) {
      ...
      case ATTESTATION_ID_DEVICE ->
          description = activity.getString(R.string.desc_attestation_id_device);
  ...
  public void updateBootloaderBanner(boolean isLocked) {
    handler.post(
        () -> {
          ...
          int lockedBg = R.color.blue_light;
          int lockedFg = R.color.blue_dark;
          int unlockedBg = R.color.warning_light;
          int unlockedFg = R.color.brown_dark;

          if (isLocked) {
            statusText.setText(R.string.bootloader_locked);
            banner.setCardBackgroundColor(ContextCompat.getColor(activity, lockedBg));
            statusText.setTextColor(ContextCompat.getColor(activity, lockedFg));
            icon.setImageResource(android.R.drawable.ic_lock_lock);
            icon.setImageTintList(
                ColorStateList.valueOf(ContextCompat.getColor(activity, lockedFg)));
          } else {
            statusText.setText(R.string.bootloader_unlocked);
            banner.setCardBackgroundColor(ContextCompat.getColor(activity, unlockedBg));
            statusText.setTextColor(ContextCompat.getColor(activity, unlockedFg));
            icon.setImageResource(android.R.drawable.ic_lock_idle_lock);
            icon.setImageTintList(
                ColorStateList.valueOf(ContextCompat.getColor(activity, unlockedFg)));
          }
        });
  }

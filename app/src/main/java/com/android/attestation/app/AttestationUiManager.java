    ...
    handler.post(
        () -> {
          ...
          if (!isVerified || bootState == null) {
            ...
            summaryTitle.setTextColor(ContextCompat.getColor(activity, R.color.error));
            summaryTitle.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_warning, 0, 0);
            summaryTitle.setCompoundDrawableTintList(
                ColorStateList.valueOf(ContextCompat.getColor(activity, R.color.error)));
          ...
          switch (bootState) {
            case VERIFIED -> {
              ...
              summaryTitle.setTextColor(ContextCompat.getColor(activity, R.color.success));
              summaryTitle.setCompoundDrawablesWithIntrinsicBounds(
                  0, R.drawable.ic_check_circle, 0, 0);
              summaryTitle.setCompoundDrawableTintList(
                  ColorStateList.valueOf(ContextCompat.getColor(activity, R.color.success)));
              summarySubtitle.setText(R.string.summary_subtitle_verified);
            }
            case SELF_SIGNED -> {
              summaryTitle.setText(R.string.summary_title_warning);
              summaryTitle.setTextColor(ContextCompat.getColor(activity, R.color.warning));
              summaryTitle.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_warning, 0, 0);
              summaryTitle.setCompoundDrawableTintList(
                  ColorStateList.valueOf(ContextCompat.getColor(activity, R.color.warning)));
    ...
    handler.post(
        () -> {
          ...
          if (isLocked) {
            ...
            banner.setCardBackgroundColor(ContextCompat.getColor(activity, R.color.blue_light));
            statusText.setTextColor(ContextCompat.getColor(activity, R.color.blue_dark));
            ...
            banner.setCardBackgroundColor(ContextCompat.getColor(activity, R.color.warning_light));
            statusText.setTextColor(ContextCompat.getColor(activity, R.color.brown_dark));
